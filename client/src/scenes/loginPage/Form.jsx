...
const registerSchema = yup.object().shape({
  ...
  age: yup
    .number()
    .min(8, "You must be at least 8 years old to use this platform.")
    .max(15, "You must be at most 15 years old to use this platform.")
    .required("required"),
  aadhar: yup
    .string()
    ...
    >
      {({
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            {/* Aadhar input field only on register page */}
            {isRegister && (
              <TextField
                label="Aadhar Number"
                onBlur={handleBlur}
